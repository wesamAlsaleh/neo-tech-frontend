...
export default function ProductCard(props: ProductCardProps) {
  ...
  return (
    // product container
    <div className="relative p-4 rounded-lg flex flex-col justify-between bg-white hover:shadow-lg hover:shadow-orange-200 transition-shadow duration-300 ease-in-out h-full">
      {/* Discount Badge */}
      {product.onSale ? (
